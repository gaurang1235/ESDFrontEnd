...
export default function Home() {
    ...
    function generatePDF(user) {
        ...
        doc.text(user.employee_id.first_name, 80, 40);
        doc.text(user.employee_id.last_name, 95, 40)
        doc.text('Email_id ', 20, 50);
        doc.text(user.employee_id.email, 80, 50);
        doc.text('Title ', 20, 60);
        doc.text(user.employee_id.title, 80, 60);
        doc.text('Date ', 20, 70);
        doc.text(user.payment_date, 80, 70);
        doc.text('Amount ', 20, 80);
        doc.text(user.amount.toString(), 80, 80);
        doc.text('Description ', 20, 90);
        doc.text(user.description, 80, 90);
        doc.text('---------------------------------------------------------------------------------------------------', 20, 100);
    ...
    return (
        ...
        <div>
            <Navbar heading={"Welcome, " + fname + " " + lname} buttonName={"Logout"} buttonLink={"/"} />
